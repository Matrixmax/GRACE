...
from baselines.RepoHyper.src.repo_graph.search_policy.base_search import SimilarSearchPolicy
...
class ProximitySearchPattern(ProximitySearch):
	...
	def __init__(self, embeddings, adj_matrix, type_matrices, index_to_node_type, index_to_name, search_config, expand_config, metric):
		...
		with open("/data/wxl/graphrag4se/baselines/RepoHyper/src/repo_graph/search_policy/patterns.json", "r") as f:
